#!/bin/bash
#SBATCH -J wavlm_attn_f1_evalonly
...
#SBATCH --requeue
#SBATCH --gres=gpu:1
#SBATCH -o logs/baselines/wavlm_attn_f1_evalonly_%j.out
#SBATCH -e logs/baselines/wavlm_attn_f1_evalonly_%j.err
...
echo "Start: $(date)"
python baselines/eval_only_wavlm_attn_gs_f1.py
echo "Done: $(date)"
