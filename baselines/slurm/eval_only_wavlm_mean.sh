...
#SBATCH --requeue
#SBATCH --gres=gpu:1
#SBATCH -o logs/baselines/wavlm_mean_evalonly_%j.out
#SBATCH -e logs/baselines/wavlm_mean_evalonly_%j.err
...
echo "Start: $(date)"
python baselines/eval_only_wavlm_mean.py
echo "Done: $(date)"
