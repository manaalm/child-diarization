#!/bin/bash
#SBATCH -J fused_medium_evalonly
...
#SBATCH --requeue
#SBATCH --gres=gpu:1
#SBATCH -o logs/baselines/fused_medium_evalonly_%j.out
#SBATCH -e logs/baselines/fused_medium_evalonly_%j.err
...
echo "Start: $(date)"
python baselines/eval_only_fused_medium_cross_child.py
echo "Done: $(date)"
