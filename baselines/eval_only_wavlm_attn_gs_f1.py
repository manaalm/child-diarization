"""Eval-only wrapper for wavlm_attn_groupstrat3_f1 (training cancelled past
...
CFG.seen_child_split_dir = "whisper-modeling/seen_child_splits_groupstrat_3fold/fold_1"
...
test_metrics["note"] = "BIDS groupstrat3 f0 eval-only on best ckpt (cancelled past patience) (training cancelled at ep 15 past patience)"
